        ...
        <?php  
                ...
                if($query->have_posts()){
                  while($query->have_posts()){
                    $query->the_post();
        ?>
        <div class="col-md-4 col-xs-12 advisor-box"><p class="o-name"><?php echo get_the_title(); ?></p><p class="o-title"><?php echo get_field('position'); ?></p><p class="o-email"><?php echo get_field('email'); ?></p></div>
      <?php
              }
            }
            wp_reset_query();
